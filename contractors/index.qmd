...
# 
# [Read an overview of our rehab process.](#rehab-process-overview)
# :::
# 
# {{< include ../_bids.qmd >}}
```
...
### Permits
**All permits must be in place at the time of the pre-construction meeting**. The write-up must be attached to the permit in Accela, and include "SCDH Project" in the permit label. 
