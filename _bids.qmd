...
out_to_bid <- raw_cases |> 
  filter(project_status == "out for bid" & bid_date < today()) |> 
...
Non-LOSB projects for the 11/17 bid opening were mistakenly not advertised in local papers and will be rebid 11/22.
:::
